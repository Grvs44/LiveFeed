...
export const msalConfig = {
    auth: {
        ...
        redirectUri: 'https://thankful-water-01d7d6503.4.azurestaticapps.net/', // You must register this URI on Azure Portal/App Registration. Defaults to window.location.origin
